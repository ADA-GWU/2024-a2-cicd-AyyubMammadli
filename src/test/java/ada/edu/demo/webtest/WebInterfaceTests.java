...
class WebInterfaceTests {
	...
	public void CreateUser() {
		...
		try {
			...
			Thread.sleep(2000);
				firstNameInput.sendKeys("Ayyub");
			Thread.sleep(2000);
			lastNameInput.sendKeys("Mammadli");
			Thread.sleep(2000);
			emailInput.sendKeys("amammadli12194@ada.edu.az");
			Thread.sleep(2000);
		}
		catch (Exception ex) {
	...
	public void CheckUser() {
		...
		List<WebElement> bodyElementFName = webDriver.findElements(By.xpath("//*[contains(text(), 'Ayyub')]"));
	...
	public void SearchStudent() {
		webDriver.get("http://localhost:"+port+"/student/search?first=Ayyub&last=Mammadli");
